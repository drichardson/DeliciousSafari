...
extern NSString *dxJsonObjectStartString;
extern NSString *dxJsonObjectEndString;
extern NSString *dxJsonArrayStartString;
extern NSString *dxJsonArrayEndString;
extern NSString *dxJsonKeyValueSeparatorString;
extern NSString *dxJsonValueSeparatorString;
extern NSString *dxJsonStringDelimiterString;
extern NSString *dxJsonStringEscapedDoubleQuoteString;
extern NSString *dxJsonStringEscapedSlashString;
extern NSString *dxJsonTrueString;
extern NSString *dxJsonFalseString;
extern NSString *dxJsonNullString;


@interface NSScanner (PrivateDXBSJSONAdditions)
